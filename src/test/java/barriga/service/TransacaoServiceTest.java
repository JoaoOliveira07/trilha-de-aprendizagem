...
import static barriga.domain.builders.TransacaoBuilder.umaTransacao;
...
import trilha.testsjunit.barriga.service.TransacaoService;
                    ...
                    assertAll("Conta",
                            ...
                            () -> {
                                assertAll("Usuário",
                                        ...
                                        () -> assertEquals("12345678", transacaoSalva.getConta().usuario().getSenha())
                                );
                            }
                    );
                }
